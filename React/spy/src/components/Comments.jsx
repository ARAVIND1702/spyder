...
const Comments = () => {
  return (
    ...
    <div className=' h-full bg-black flex flex-col min-h-[100vh]  mx-auto max-w-[90vw] 2xl:max-w-[57vw] lg:max-w-[80vw] justify-center items-center'>
  <img src={release} className='max-h-96 md:max-w-lg mx-auto items-center pb-16 align-middle'/>
   <div className='flex flex-wrap w-full text-white'>
    <div className='p-6 md:basis-[40%]'>
    <img src={poster} className='max-w-full h-auto align-middle'/>
    </div>
    <div className='md:basis-[60%] p-6  text-[14px] font-[600] text-white'>
